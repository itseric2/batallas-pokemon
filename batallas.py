...
print(titulo)
print("ZEUS el dios del rayo tiene las habilidades de:\n1-Rayo(60 daño) el cual tiene probabilidad de critico(120 daño), lanzar un super rayo(300 daño), mega rayo(600 daño) y ultra rayo(2000 daño)")
print("2-Tormenta(80 daño) tiene probabilidad de lanzar una tormenta de ira(1500)\n3-Criatura de saturno(100)\n4-Campo electrico(120)\n5-Control del clima(140\n6-dominio de la energia(160)")
print()
print("KHONSHU el dios lunar tiene las habilidades de:\n1-Media luna(70)\n2-piedras lunares(120) triple(360) \n3-Meteoro lunar(130) lluvia(1300) \n4-luna llena(140)\n5-Moon fall(150)\n6-Oz lunar(200) manchada(500) \n7-Two moon(280) Quad(560) ")
print()
print("ANUBIS un dios de la muerte tiene las habilidades de:\n1-Almas perdidas(40)\n2-Apocalipsis final(60)\n3-Tumba del rey(70),\n4-Ejercito de muertos(80)\n5-Poder prestado(110)\n6-Hacha de muerte(250) triple(750) \n7-Oz de muerte(350) doble(700)\n8-Muerte(400) lluvia(4000)")
print()
print("1- Zeus\n2- Khonshu\n3- Anubis")
...
while cp == 2 :
    ...
    if enemigo3["vidab"] > 0 :
        ...
        while bool_valueb :
            ...
            x=int(input("{ "))
            if x == 1:
                enemigo3["vidab"] -= khonshu["fallot"]
                if khonshu["fallot"] == khonshu["fallo"]:
                    print("¡Fallaste!")
                print("Vida del oponente", enemigo3["vidab"])
            elif x ==2:
                enemigo3["vidae"] -= khonshu["fallome"]
